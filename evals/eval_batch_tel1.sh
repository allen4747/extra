#!/usr/bin/env bash
# Telecom-1 server (dgx-3nc-11-14): 3e-6 runs at step 250.
#
# Usage:
#   NUM_GPUS=4 bash eval_batch_tel1.sh           # auto-detect 4 free GPUs and wait
#   CUDA_VISIBLE_DEVICES=0,1,2,3 bash eval_batch_tel1.sh   # use specific GPUs
...
RUNS=(
    "09_ExTra_NgramNovelty_3e6_Qwen3_tel1:250"
)
