...
python3 -m verl.trainer.main_ppo \
    algorithm.adv_estimator=cdpo \
    data.train_files=$HOME/data/math_dapo/train.parquet \
    ...
    trainer.project_name='verl_dapo17k' \
    trainer.experiment_name='qwen3_1_7b_sentence_emb01_cos_positiv_norm_shortmem' \
