#!/usr/bin/env bash
# Wave 2, Slot C: Ablation - regen ONLY on Nemotron
...
EXP_NAME="07_ExTra_RegenOnly_Nemotron_1.5B"
...
python3 -m verl.trainer.main_ppo \
  ...
  trainer.default_local_dir="/external1/wenyang/checkpoints/ExTra_Final/$EXP_NAME" \
