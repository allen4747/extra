#!/usr/bin/env bash
# Wave 2, Slot A: Ablation - guided regeneration ONLY (no curiosity reward)
# novelty_reward_scale=0 disables the curiosity bonus while keeping memory tracking active.
...
EXP_NAME="03_ExTra_RegenOnly_R1Distill_1.5B"
