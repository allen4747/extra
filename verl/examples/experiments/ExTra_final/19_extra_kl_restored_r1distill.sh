#!/usr/bin/env bash
# Restored ExTra-Full + KL loss for late-training stability on R1-Distill-Qwen-1.5B.
# Same as Script 17 (restored config) + KL regularization:
#   - use_kl_loss=True, kl_loss_coef=0.001
# Tests whether KL anchoring prevents the oscillation seen at steps 200+.
...
EXP_NAME="19_ExTra_KL_Restored_R1Distill_1.5B"
