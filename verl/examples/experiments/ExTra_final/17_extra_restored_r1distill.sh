#!/usr/bin/env bash
# Restored ExTra-Full (curiosity + guided resampling) on R1-Distill-Qwen-1.5B.
# Restores the working config from ExTra_Research/09b:
#   - train_batch_size=256 (was 128)
#   - rollout.n=8 (was 4)
#   - max_response_length=8192 (was 16384)
#   - guided_resampling.tau=0.1 (was 1.0 — tau=1.0 = uniform = no guidance!)
#   - ppo_micro_batch_size_per_gpu=8 (was 4)
...
EXP_NAME="17_ExTra_Restored_R1Distill_1.5B"
