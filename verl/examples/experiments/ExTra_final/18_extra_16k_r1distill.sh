#!/usr/bin/env bash
# ExTra-Full with 16384 response length — isolation experiment.
# Tests whether max_response_length=16384 independently hurts when other params
# are correctly restored (batch=256, n=8, tau=0.1).
# Compare against Script 17 (same but response=8192) to isolate the effect.
# Note: 16384 forces micro=4 and ppo_max_token=65536 for memory.
...
EXP_NAME="18_ExTra_16k_R1Distill_1.5B"
