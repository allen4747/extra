#!/usr/bin/env bash
# EMNLP rebuttal — Full ExTra on Qwen3-1.7B, second seed (2024).
#
# One node, 8 x H100. Paired with 03_grpo_qwen3_seed2.sh.
#
# Also enables log_mte_gap so this run contributes MTE-vs-random-prefix
# evidence for the R2 rebuttal paragraph in addition to the 8B run's log.
...
EXP_NAME="${EXP_NAME:-04_ExTra_Full_Qwen3_seed2}"
