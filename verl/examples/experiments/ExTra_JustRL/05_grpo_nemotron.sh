#!/usr/bin/env bash
# GRPO baseline on Nemotron-1.5B — full JustRL recipe, 4 GPUs.
...
EXP_NAME="05_GRPO_Nemotron_JustRL"
...
python3 -m verl.trainer.main_ppo \
  ...
  trainer.default_local_dir="/external1/wenyang/checkpoints/ExTra_JustRL/$EXP_NAME" \
