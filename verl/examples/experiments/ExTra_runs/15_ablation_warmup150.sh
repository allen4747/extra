#!/usr/bin/env bash
# Ablation: Regeneration warmup = 200 steps (default 100)
# Tests whether delaying regeneration helps (let curiosity stabilize first)
...
EXP_NAME="ExTra-Full-Warmup150-JustRL-Qwen2.5-1.5B"
...
python3 -m verl.trainer.main_ppo \
  ...
  algorithm.guided_resampling.warmup_steps=150 \
