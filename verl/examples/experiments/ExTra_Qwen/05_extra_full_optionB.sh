#!/usr/bin/env bash
# ExTra Full with Option B novelty (after-norm, no group normalization, no dynamic scaling).
# Novelty reward scale=0.1, max_rollouts_per_prompt=6 (sibling-focused comparison).
...
EXP_NAME="05_ExTra_Full_OptionB_Qwen3"
