#!/usr/bin/env bash
# ExTra Full + PassRate Curriculum Sampler on Qwen3-1.7B — 4 GPUs.
# Downweights easy problems (pass_rate >= 2/3) to 0.1 sampling weight.
...
EXP_NAME="04_ExTra_Full_Curriculum_Qwen3"
...
python3 -m verl.trainer.main_ppo \
  ...
  data.sampler.class_name='PassRateCurriculumSampler' \
  data.sampler_n_rollout=8 \
  data.sampler_easy_weight=0.1 \
  data.sampler_ema_alpha=0.3 \
