#!/usr/bin/env bash
# ExTra with policy-surprise novelty (Option B, after norm).
# Rewards correct solutions that the current policy finds unlikely.
# Uses sequence log-probs already computed — zero additional model cost.
...
EXP_NAME="10_ExTra_PolicySurprise_3e6_Qwen3"
...
python3 -m verl.trainer.main_ppo \
  ...
  algorithm.curiosity.novelty_metric=policy_surprise \
