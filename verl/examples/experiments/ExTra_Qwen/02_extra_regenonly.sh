#!/usr/bin/env bash
# ExTra RegenOnly on Qwen3-1.7B — 4 GPUs, prefix-guided resampling only.
# Warmup=30 steps (dataset is ~17 steps/epoch, so ~1.7 epochs before activation).
...
EXP_NAME="02_ExTra_RegenOnly_Qwen3"
