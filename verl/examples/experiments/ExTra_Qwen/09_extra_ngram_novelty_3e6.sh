#!/usr/bin/env bash
# ExTra with n-gram count-based novelty (Option B, after norm).
# Uses token bigram visitation counts instead of embedding cosine distance.
# No embedding model needed — faster per step.
...
EXP_NAME="09_ExTra_NgramNovelty_3e6_Qwen3"
...
python3 -m verl.trainer.main_ppo \
  ...
  algorithm.curiosity.novelty_metric=ngram_count \
  algorithm.curiosity.novelty_ngram=2 \
